...
class Commentaire
{
     ...
     * @Assert\Length(min=5, max=39, minMessage="La description doit comporter au moins 5 caractères", maxMessage="La description doit comporter au plus 5 caractères")
     */
    private ?string $description_c = null;

    /**
     * @ORM\ManyToOne(targetEntity=Reclamation::class, inversedBy="commentaires")
     */
